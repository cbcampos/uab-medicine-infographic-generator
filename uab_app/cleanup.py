...
def infer_source_profile_llm(
    ...
    user_msg = (
        ...
        "- Citation fields must be extracted from the source metadata/title/journal/year/authors exactly; do not rewrite "
        "or simplify the article title, journal name, author surname, or year.\n"
        "- Keep implications restrained and source-grounded. Do not infer clinical advice, patient behavior instructions, "
        "community resources, or intervention recommendations unless the source explicitly recommends those actions.\n"
